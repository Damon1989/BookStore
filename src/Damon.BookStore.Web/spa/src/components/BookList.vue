  ...
  <div>
    <el-row :gutter="20">
      ...
      <el-col :span="1" :offset="1">
        <el-button @click="dialogNewFormVisible = true">new</el-button>
      </el-col>
    </el-row>
    ...
    <el-dialog title="图书" :visible.sync="dialogNewFormVisible">
      <el-form :model="newform">
        <el-form-item label="活动名称" :label-width="formLabelWidth">
          <el-input v-model="newform.name" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="Publish Date" :label-width="formLabelWidth">
          <el-date-picker type="date" v-model="newform.publishDate" autocomplete="off"></el-date-picker>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    newBook() {
      var that = this;
      this.$axios.post("/api/app/book", this.newform).then((response) => {
